...
namespace BitcoinLib.Services
{
    ...
    public partial class CoinService : ICoinService
    {
        ...
        public string GetMasternode(string param1, string param2 = null)
        {
            return _rpcConnector.MakeRequest<string>(RpcMethods.masternode, param1, param2);
        }
        ...
        public dynamic ListMasternodes(string info = "full")
        {
            return _rpcConnector.MakeRequest<dynamic>(RpcMethods.masternode, "list", info);
        }

        public dynamic ControlMasternode(string command = "")
        {
            return _rpcConnector.MakeRequest<dynamic>(RpcMethods.masternode, command);
        }
